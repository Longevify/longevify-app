...
export default async function HomePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1080px] px-4 py-6 sm:px-6 sm:py-10">
      ...
      {/* Lucas (2026-05-23 v2): "card de 'suas tarefas' não está alinhado
          com o card de idade biológica no que tange a borda inferior."
          items-stretch + lg:h-full em ambos os filhos faz com que a
          TodoSidebar termine alinhada com a borda inferior do BioAge. */}
